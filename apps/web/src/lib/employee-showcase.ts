...
export const employeeShowcase: EmployeeShowcase[] = [
  {
    ...
    doesNot: ['No inventa respuestas cuando no tiene información', 'No sustituye decisiones delicadas de tu equipo'],
  ...
  },
  {
    ...
    doesNot: ['No envía comunicaciones fuera de la cuenta configurada', 'No comparte contactos entre empresas'],
    integrations: ['Brevo', 'Empleado24 Brain', 'Google Calendar'],
    examples: ['“Envía el presupuesto que hablamos.”', '“Haz seguimiento a quienes no respondieron.”'],
  ...
  },
  {
    ...
    doesNot: ['No promete precios que no hayas autorizado', 'No cierra decisiones que requieran tu aprobación'],
  ...
  },
  {
    ...
    doesNot: ['No responde fuera de tus reglas de negocio', 'No pierde el contexto de un cliente existente'],
  ...
  },
  {
    ...
    doesNot: ['No fija precios sin tu catálogo o indicaciones', 'No envía un presupuesto sin que lo revises cuando sea necesario'],
    integrations: ['Empleado24 Brain', 'Especialista Email IA', 'Closer IA'],
    examples: ['“Prepara el presupuesto de la reforma del salón.”', '“Recuérdame llamar a este cliente en dos días.”'],
    faq: [{ question: '¿Puedo usar mis propios precios?', answer: 'Sí, parte de los costes y márgenes que indiques para tu empresa.' }, { question: '¿Dónde se guarda el historial?', answer: 'Queda asociado al cliente dentro de tu empresa.' }],
  },
];

export const employeeBySlug = Object.fromEntries(employeeShowcase.map((employee) => [employee.slug, employee]));
