...
export default async function BusinessPage() {
  ...
  const [{ data: events }, { data: companies }, { data: subscriptions }, { data: invoices }, { data: purchases }, { data: calls }, { data: usage }, { data: blocked }, { data: webhooks }, { data: guardian }, { data: opportunities }] = await Promise.all([
  ...
  const mrr = active.reduce((sum, s) => sum + ({ one_employee: 9700, two_employees: 19700, five_employees: 39700, employee_email: 9700, employee_closer: 19700 }[s.plan_key ?? ''] ?? 0), 0);
