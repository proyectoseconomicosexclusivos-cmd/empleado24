...
export default async function BusinessPage() {
  ...
  const [{ data: events }, { data: companies }, { data: subscriptions }, { data: invoices }, { data: purchases }, { data: calls }, { data: usage }, { data: blocked }, { data: webhooks }, { data: guardian }, { data: opportunities }, { data: whatsappConversations }, { data: whatsappMessages }, { data: daily }] = await Promise.all([
